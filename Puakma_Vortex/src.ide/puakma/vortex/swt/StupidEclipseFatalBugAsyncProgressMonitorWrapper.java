 ...
 * </p>
 * 
 * TODO: if this is changed in 3.3 remove this class (AccumulatingProgressMonitor)
 */
public class StupidEclipseFatalBugAsyncProgressMonitorWrapper extends ProgressMonitorWrapper {
     ...
     */
    public StupidEclipseFatalBugAsyncProgressMonitorWrapper(IProgressMonitor monitor, Display display) {
        super(monitor);
