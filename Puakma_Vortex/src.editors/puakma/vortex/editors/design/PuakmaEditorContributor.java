 ...
 */
public class PuakmaEditorContributor extends MultiPageEditorActionBarContributor
{
	 ...
	 */
	public PuakmaEditorContributor()
	{
		super();
		createActions();
	}
	...
	private void createActions()
	{
		sampleAction = new Action() {
			public void run()
			{
				MessageDialog.openInformation(null, "Puakma Vortex IDE Plug-in",
