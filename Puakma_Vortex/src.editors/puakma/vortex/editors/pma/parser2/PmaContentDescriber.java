...
public class PmaContentDescriber implements ITextContentDescriber
{
  final private static QualifiedName[] SUPPORTED_OPTIONS = { IContentDescription.CHARSET,
      IContentDescription.BYTE_ORDER_MARK, IContentDescriptionExtended.DETECTED_CHARSET,
                                  ...
                                  IResourceCharsetDetector detector) throws IOException
  {
    ...
    // processing same
    // content again.
    EncodingMemento encodingMemento = ((HTMLResourceEncodingDetector) detector)
        .getEncodingMemento();
    ...
    if(!encodingMemento.isValid()) {
      ...
      description.setProperty(IContentDescriptionExtended.UNSUPPORTED_CHARSET,
                              encodingMemento.getInvalidEncoding());
      description.setProperty(IContentDescriptionExtended.APPROPRIATE_DEFAULT,
