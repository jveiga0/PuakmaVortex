...
/**
 * Splitter class. It's taken from GEF.
 * 
 * TODO: in 3.3 look at the possible reimplementation in gef
 *
...
public class Splitter extends Composite
{
  ...
  /**
   * @return SWT.HORIZONTAL if the controls in the SashForm are laid out side by side or
  ...
  /**
   * @return the control that currently is maximized in the SashForm. This value may be
   * null.
   */
   ...
   * @param orientation is the orientation described above
   */
  ...
  /**
   * Specify the control that should take up the entire client area of the SashForm. If
   * one control has been maximized, and this method is called with a different control,
   * the previous control will be minimized and the new control will be maximized.. if the
   * value of control is null, the SashForm will minimize all controls and return to the
   * default layout where all controls are laid out separated by sashes.
   * 
   * @param control is the control to maximize
   */
